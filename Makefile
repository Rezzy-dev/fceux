...
OPTIMIZE =  -Ofast -flto -fomit-frame-pointer -fno-builtin   \
...
CXXFLAGS += $(CFLAGS)
LDFLAGS  += $(CC_OPTS) -flto
ifdef STATIC
LDFLAGS  += -static-libgcc -static-libstdc++
endif
LIBS = $(SDL_LIBS) -lz -lm -flto
...
$(TARGET).opk: $(TARGET)
	@echo Creating $@...
	@mksquashfs $(TARGET) bin/*.bmp fceux/fceux.png fceux/default.retrostone2.desktop $@ -all-root -no-xattrs -noappend -no-exports
